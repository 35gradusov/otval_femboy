label thirty_five_grad_init:
    ...
    python:
        if persistent.text_size == 'large':
            persistent.thirty_five_grad_glitch_text_size = 35
        elif persistent.text_size == 'small':
            persistent.thirty_five_grad_glitch_text_size = 28
        config.skipping                             = False
        _skipping                                   = False
        persistent.thirty_five_grad_main_menu_music_old        = config.main_menu_music
        # persistent.thirty_five_grad_mouse_displayable_old      = config.mouse_displayable
        persistent.thirty_five_grad_window_show_transition_old = config.window_show_transition
        persistent.thirty_five_grad_window_hide_transition_old = config.window_hide_transition
        persistent.thirty_five_grad_exit_transition_old        = config.exit_transition
        persistent.thirty_five_grad_text_speed_old             = preferences.text_cps
        save_name                                   = ('35°')
        preferences.gl_powersave                    = False
        preferences.gl_framerate                    = None
        config.main_menu_music                      = thirty_five_grad_mm_music
        thirty_five_grad_screens_active()
    image ctc_animation                             = Animation("images/gui/ctc.png", 0.15, "images/gui/ctc.png", 0.15)
    image ctc_animation_nvl                         = Animation("images/gui/ctc.png", 0.15, "images/gui/ctc.png", 0.15)    
    show thirty_five_grad_logo_startup at thirty_five_grad_logo_startup_anim
    #show thirty_five_grad_text_logo_startup at thirty_five_grad_text_logo_startup_anim
    $ renpy.pause(3,5, hard=True)
    play music  thirty_five_grad_mm_music fadein 5
    hide thirty_five_grad_logo_startup
    #hide thirty_five_grad_text_logo_startup
    $ renpy.pause(0.1, hard=True)
    return


label thirty_five_grad_exit_label:
    python:
        config.hard_rollback_limit = 0
        config.rollback_enabled = False
        _game_menu_screen = u''
    ...
    python:
        thirty_five_grad_screens_diactivate()
        config.main_menu_music = persistent.thirty_five_grad_main_menu_music_old
        _skipping = True
...
label thirty_five_grad_start:
    ...
    scene bg black with fade
    stop music fadeout 3
    $ renpy.display.screen.screens[("main_menu", None)] = renpy.display.screen.screens[("thirty_five_grad_start_blur_sc", None)]
    return
...
#     play sound thirty_five_grad_glitch_transition_1
#     scene bg thirty_five_grad_eyes_forest_glitch_epil 
...
#     # '(Славя, удивлённая)'
#     show 35grad_slavya 3 fear sport at thirty_five_grad_sunset_lighting with dspr
...
#     # '(Славя, покраснела)'
#     show 35grad_slavya 2 shy sport at thirty_five_grad_sunset_lighting with dspr
...
#     # '(Славя, удивлённая)'
#     show 35grad_slavya 2 laugh sport at thirty_five_grad_sunset_lighting with dspr
...
#     show 35grad_slavya 2 sad sport at thirty_five_grad_sunset_lighting with dspr
...
#     scene bg thirty_five_grad_musuc_sunset with fade
...
#     if persistent.thirty_five_grad_blur_pref:
#         show bg thirty_five_grad_musuc_sunset blured with dspr
...
#     # '(Славя, поменять эмоцию)'
#     show 35grad_slavya 2 sad sport at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     # '(Славя, поменять эмоцию)'
#     show 35grad_slavya 2 smile sport at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     # '(Славя, забеспокоеная)'
#     show 35grad_slavya 2 hmuri sport at thirty_five_grad_sunset_lighting with dspr
...
#     show 35grad_alice 2 laugh reb at thirty_five_grad_sunset_lighting with dspr
...
#     hide 35grad_alice 1 normal joy reb at thirty_five_grad_sunset_lighting with dissolve
...
#     show 35grad_slavya 2 laugh sport at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     with move
#     show 35grad_olga 2 normal nightgown at thirty_five_grad_sunset_lighting:
...
#     show 35grad_olga 3 angry nightgown at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     show 35grad_slavya 3 fear sport at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     show 35grad_olga 2 normal nightgown at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     show 35grad_olga 2 normal nightgown with dissolve:
#             xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_olga 3 normal nightgown with dissolve_fast
...
#     show 35grad_olga 2 normal nightgown with dissolve_fast
...
#     show 35grad_olga 3 surprised nightgown with dissolve_fast
...
#     # '(её спрайт пропадает)'
#     hide 35grad_olga 2 normal nightgown with dissolve_fast
...
#     show 35grad_olga 1 normal normal normal pio with dspr:
#         xanchor 0.5 xalign 0.5
...
#     show 35grad_olga 2 smile pio with dspr
...
#     show 35grad_olga 3 normal pio with dspr
...
#     show 35grad_olga 3 surprised pio with dspr
...
#     show 35grad_olga 3 angry pio with dspr
...
#     # '(Ольга пропадает)'
#     hide 35grad_olga 1 normal normal normal pio with dissolve_fast
#     if persistent.thirty_five_grad_blur_pref:
...
#     $ renpy.pause(1.2, hard=True)
#     scene bg black at thirty_five_grad_vhs
#     'Закрыл глаза и медленно сосчитал до десяти. (закрыть глаза) {w} Открыл глаза.'
#     show unblink
#     $ renpy.pause(1.5, hard=True)
...
#     show 35grad_slavya 1 normal normal pio with dspr
...
#     show 35grad_electronnik 1 normal normal pio with dspr
...
#     show 35grad_olga 2 normal hat pio:
...
#     show 35grad_slavya 3 fear pio with dissolve_fast
...
#     show 35grad_olga 3 angry hat pio with dissolve_fast
...
#     show 35grad_olga 2 normal hat pio with dissolve_fast
...
#     stop music fadeout 2.0
#     # '(спрайт Алисы)'
#     show 35grad_alice 1 normal normal normal reb with dspr:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     # '(Алиса пропадает)'
#     hide 35grad_alice 2 shy reb with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_lena 1 normal shy pio with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
#         show bg ext_dining_hall_near_day at thirty_five_grad_blur with dissolve
...
#     show 35grad_lena 2 shy pio with dissolve_fast
...
#     show 35grad_lena 2 angry pio with dspr
...
#         xanchor 0.5 xalign 0.0
#     with move

#     show 35grad_alice 1 normal joy reb:
#         xanchor 0.5 xalign 1.0
#     with dissolve
...
#     'Но, так или иначе, я всё равно немного улыбнулся от такой милоты. Всегда интересно наблювать за действиями друзей, как они между собой выясняют отношения и так далее.'
...
#     show 35grad_shuric 1 normal normal pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     hide 35grad_shuric 1 normal normal pio with dissolve
...
#     show 35grad_miku 3 shy pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 2 laugh pio with dissolve_fast
#     thirty_five_grad_mi 'Ах, прости, я не представилась! Меня Мику зовут, правда-правда!'
#     show 35grad_miku 2 normal pio with dspr
...
#     show 35grad_miku 2 laugh pio with dspr
...
#     show 35grad_miku 1 normal sad2 pio with dissolve_fast
...
#     show 35grad_miku 1 normal normal normal pio with dspr
...
#     show 35grad_miku 3 smile pio with dissolve_fast
...
#     show 35grad_miku 1 normal sad pio with dissolve_fast
...
#     show 35grad_miku 1 normal sad pio with dspr
...
#     show 35grad_miku 3 shy pio with dissolve_fast

#     'Она раскраснелась так, словно я признался ей в любви.'

#     show 35grad_miku 3 normal pio with dissolve_fast
...
#     show 35grad_miku 2 normal pio with dissolve
#     play sound sfx_head_heartbeat
#     $ renpy.pause(1.0, hard=True)
...
#     show 35grad_zhenya 1 normal normal pio with dspr
...
#     # '(спрайт Мику)'
#     show 35grad_miku 2 laugh pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 2 sad pio with dspr
...
#     show 35grad_miku 2 normal pio with dissolve_fast
...
#     show 35grad_miku 2 scared pio with dspr
...
#     show 35grad_miku 1 normal sad pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_viola 1 normal normal normal reb with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_viola 1 normal shy reb with dspr
...
#     show 35grad_viola 1 normal normal normal reb with dspr
...
#     show 35grad_lena 1 normal normal pio with dspr
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_lena 1 normal shy pio with dspr
...
#     show 35grad_lena 2 angry pio with dissolve_fast
...
#     hide 35grad_lena 1 normal normal pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_electronnik 1 normal normal pio:
#         xanchor 0.5 xalign 0.2
#     with dissolve
...
#     show 35grad_olga 3 normal pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_olga 1 normal normal normal pio with dissolve_fast
...
#     show 35grad_olga 3 angry pio with dissolve_fast
...
#     show 35grad_olga 2 normal pio with dspr
...
#     # '(спрайт Ольги)'
#     show 35grad_olga 3 angry pio with dissolve
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_olga 2 normal pio with dissolve_fast
...
#     show 35grad_miku 2 scared pio:
#         xanchor 0.0 xalign 0.0 yalign 1.0 # Слева
#     with dissolve_fast
#     show 35grad_alice 2 laugh reb:
#         xanchor 0.5 xalign 0.5   # В центре
#     with dissolve_fast
#     show 35grad_slavya 2 hmuri pio:
...
#     # '(спрайт Мику пропадает)'
#     hide 35grad_miku 1 normal normal normal pio with dissolve
#     # '(музыка стоп)'
#     stop music fadeout 2.0
...
#     show 35grad_lena 1 normal normal pio:
#         xanchor 0.5 xalign 0.5 yalign 0.5
#     with dissolve
#     show 35grad_alice 1 normal normal normal reb:
#         xanchor 0.0 xalign 0.0 yalign 0.5
#     with dissolve
#     show 35grad_slavya 1 normal normal pio:
...
#     # '(появляется Мику)'
#     show 35grad_miku 2 laugh pio at thirty_five_grad_sunset_lighting_revers with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 1 normal normal normal pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_miku 1 normal sad pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     show 35grad_miku 2 laugh pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     # '(Мику удивлённая)'
#     show 35grad_miku 2 scared pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     show 35grad_miku 3 shy pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
#     'Девочка покраснела, а затем спустилась с лестницы, что сделал и я, а затем вместе зашагали вперёд.'
#     show 35grad_miku 2 laugh pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_miku 2 normal pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     show 35grad_miku 1 normal normal normal pio at thirty_five_grad_sunset_lighting with dspr:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 2 laugh pio at thirty_five_grad_sunset_lighting with dissolve_fast
...
#     # '(спрайт Ольги обычный)'
#     show 35grad_olga 1 normal normal normal pio at thirty_five_grad_sunset_lighting_revers with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_olga 2 surprised pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_olga 3 normal pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast

#     thirty_five_grad_mt 'Рада такое слышать. Главное смотри, чтоб твой запал также быстро не пропал. А, кстати! Вспомнила.'
#     hide 35grad_olga 3 normal pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_olga 1 normal normal normal pio at thirty_five_grad_sunset_lighting_revers with dspr:
#         xanchor 0.5 xalign 0.5
...
#     hide 35grad_olga 1 normal shy pio at thirty_five_grad_sunset_lighting with dissolve
...
#     scene bg thirty_five_grad_musuc_sunset with dissolve
...
#     show 35grad_miku 1 normal normal normal pio at thirty_five_grad_sunset_lighting_revers with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 1 normal sad2 pio at thirty_five_grad_sunset_lighting_revers with dspr

#     'Но её лицо изображало реальное смущение и грусть. Отчего решил, что давить на Мику – не лучшая идея.'

#     # '(спрайт Мику обычный)'
#     show 35grad_miku 1 normal normal normal pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     'Как только тут не случился пожар? Вопрос не шуточный.'
...
#     play music music_list['sweet_darkness']
#     show 35grad_miku 2 normal pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     'Если мне не изменяет память, то в конце восьмидесятых были распространены допотопные СО-1-5. Они же счётчики однофазные.'
#     'Я в них никогда не ковырялся, так что это мой первый опыт! Почти как с девушкой. Хех.'
...
#     play sound sfx_open_cabinet_1
#     show 35grad_miku 2 sad pio at thirty_five_grad_night_lighting with dissolve_fast:
#         xalign 0.5 xanchor 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_miku 2 normal pio at thirty_five_grad_night_lighting with dissolve
...
#     show 35grad_miku 2 scared pio at thirty_five_grad_night_lighting with dspr
...
#     # '(спрайт Мику улыбающийся)'
#     show 35grad_miku 2 laugh pio at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_miku 2 normal pio at thirty_five_grad_night_lighting with dspr
#     thirty_five_grad_mi 'Хорошо, конечно. Если что – зови!'
#     hide 35grad_miku 2 normal pio at thirty_five_grad_night_lighting with dissolve
...
#     'Так... {w} Что тут у нас... {w} Серьёзно? Настолько легко? Тут словно для самых маленьких написано, что и зачем каждая кнопочка нужна.'
#     'Это меня даже разочаровало. Так теперь, по идее, везде должен был пропасть свет.'
...
#     $ renpy.display_notify('Сейчас играет:\nMIKUMYLOVE')
#     show 35grad_miku 1 normal normal normal pio at thirty_five_grad_night_lighting with dissolve:
#         xanchor 0.5 xalign 0.5
...
#     show 35grad_miku 2 laugh pio at thirty_five_grad_night_lighting with dissolve_fast
...
#     show 35grad_miku 2 sad pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     show 35grad_miku 3 normal pio at thirty_five_grad_sunset_lighting_revers with dspr
...
#     show 35grad_miku 3 normal pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     # '(спрайт Мику грустная)'
#     show 35grad_miku 1 normal sad2 pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_miku 2 sad pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     show 35grad_miku 1 normal sad pio at thirty_five_grad_sunset_lighting_revers with dissolve_fast
...
#     'Вот дурёха, а! На кой чёрт она себя так ведёт? И я не лучше: «Тогда и я нет». Клоун. Только цирк уехал, а меня тут оставили.'
#     'И смотря на ситуацию, этот вариант не такой уж и тупой.'
...
#     '...А ещё этот чёртов лес, который стоит недалеко от меня. Так и давит, зараза.'
...
#     '...Что? Как я тут очутился? И сколько времени прошло? Почему я стою на пирсе и смотрю вдаль синей реки? Я шёл сюда, словно в дымке. Не помню, как оказался здесь.'
...
#     show 35grad_slavya 2 smile pio at thirty_five_grad_night_lighting with dspr
#     thirty_five_grad_sl 'Увы, не могу. Всё же ты тоже под моей ответственностью. Так что...'
#     show 35grad_slavya 2 normal pio at thirty_five_grad_night_lighting with dspr
...
#     '...Ты никогда меня не поймёшь, что всё на самом деле куда как страшнее и даже опаснее, наверное... И лучше бы не понимала, никому такого не пожелаю.'
#     show 35grad_slavya 2 laugh pio at thirty_five_grad_night_lighting with dspr
...
#     'Кстати, насчёт неё. Нужно будет сходить и проверить её. Вдруг что-то там появилось...'
...
#     show 35grad_slavya 2 hmuri pio at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_slavya 2 sad pio at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_alice 1 normal obessed reb at thirty_five_grad_night_lighting with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     show 35grad_alice 2 normal reb at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_alice 2 laugh reb at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_alice 2 shy reb at thirty_five_grad_night_lighting with dspr
#     'Девушка глубоко задумалась. Впервые вижу её такой... Неужели и она умеет мыслить?'
...
#     show 35grad_alice 2 smile reb at thirty_five_grad_night_lighting with dspr
...
#     hide 35grad_alice 2 smile reb at thirty_five_grad_night_lighting with dissolve
#     if persistent.thirty_five_grad_blur_pref:
#         show bg ext_dining_hall_near_night at thirty_five_grad_deblur

#     'Она спустилась с лестницы и, отойдя на приличное расстояние, подмигнула мне. Странная она какая-то, но вряд ли плохая.'
#     'Бывают такие люди, которые внешне пытаются показаться агрессивными, но внутри... Интересно, а у Алисы какая история жизни?'
#     'Хотелось бы с ней поговорить просто по душам...'

#     # '(поялвяется спрайт Слави обычный. Медленно)'
#     show 35grad_slavya 1 normal normal pio at thirty_five_grad_night_lighting with dissolve2:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
#         show bg ext_dining_hall_near_night at thirty_five_grad_blur
...
#     show 35grad_slavya 3 fear pio at thirty_five_grad_night_lighting with dspr
...
#     'Надеюсь, что увижу хотя бы табличку с адресом! Как странно, что здесь нет КПП. Хоть какая-то должна же быть охрана.'
...
#     show 35grad_olga 2 normal nightgown at thirty_five_grad_night_lighting with dissolve:
#         xanchor 0.5 xalign 0.5
#     if persistent.thirty_five_grad_blur_pref:
...
#     'Встретила меня Ольга в бабушкиной ночнушке. Хотя в это время она, скорее всего, в пике моды.'

#     thirty_five_grad_alex 'Вдруг вы бы переодевались там или ещё чего.'
#     show 35grad_olga 2 surprised nightgown at thirty_five_grad_night_lighting with dspr
...
#     show 35grad_olga 2 normal nightgown at thirty_five_grad_night_lighting with dspr
...
#     'Хороший вопрос. Удивительно, чем больше я здесь нахожусь, тем... обычнее кажется это место. Не считая треклятой остановки, конечно.'
#     'Да и местные девчата... Особенные. Все красивы, умны... Хитры. И относятся ко мне как, чёрт возьми, к личности, а не на «принеси-подай-иди-нахер-не-мешай». Так что...'

#     thirty_five_grad_alex 'Хорошо здесь. Пляж с музклубом понравились. И девушки все... {w} хорошие...'
#     show 35grad_olga 3 normal nightgown at thirty_five_grad_night_lighting with dspr
#     thirty_five_grad_mt 'Но одна особенно?'

#     'Мои щёки выдали меня всего. Всё моё чёртово нутро.'
#     show 35grad_olga 2 shy nightgown at thirty_five_grad_night_lighting with dspr
...
#     '...Началось...'
#     show 35grad_olga 3 angry nightgown at thirty_five_grad_night_lighting with dissolve_fast
...
#     'А вот это было интересно. Но не так, как моя будущая встреча с подушкой.'

#     thirty_five_grad_alex 'По рукам.'
#     show 35grad_olga 2 normal nightgown at thirty_five_grad_night_lighting with dspr
#     thirty_five_grad_mt 'Вот и отлично. Спокойной ночи. И знай, в случае чего – идёшь сразу ко мне.'

#     hide 35grad_olga 2 normal nightgown at thirty_five_grad_night_lighting with dissolve
#     # ('sound')
#     play sound thirty_five_grad_light_on_off
#     scene bg int_house_of_mt_night2 with dspr

#     'Я кивнул, а затем вожатая выключила свет. Неужели этот день закончился? Хотя Ольга права. Мне нужно... Нет!'
#     'Необходимо следить как за своими словами, так и действиями. А ещё нужно будет узнать завтра, как дела у Мику, ведь вела она себя странно, и потом разобраться с Леной.'
#     'Вдруг ей тоже нужна будет помощь.'
#     '...А теперь другой вопрос. Кто поможет мне?'
#     # '(музыка стоп)'
#     stop music fadeout 2.0
#     python:
#         config.skipping = False
...
# # label thirty_five_grad_after_seven_day_anim:
# #     python:
# #         _game_menu_screen = u''
# #         config.skipping = False
# #         _skipping = False
# #     scene bg black
# #     play sound thirty_five_grad_old_desktop_pc_booting_up fadein 1
# #     $ renpy.pause(3.5, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part1 at thirty_five_grad_crt
# #     $ renpy.pause(0.25, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part2 at thirty_five_grad_crt
# #     $ renpy.pause(0.15, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part3 at thirty_five_grad_crt
# #     $ renpy.pause(0.5, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part4 at thirty_five_grad_crt
# #     $ renpy.pause(0.2, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part5 at thirty_five_grad_crt
# #     $ renpy.pause(1.2, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part6 at thirty_five_grad_crt
# #     $ renpy.pause(5.5, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part7 at thirty_five_grad_crt
# #     $ renpy.pause(0.2, hard=True)
# #     show thirty_five_grad_after_seven_day_image_part8 at thirty_five_grad_crt
# #     $ renpy.pause(0.8, hard=True)
# #     scene bg black
# #     $ renpy.pause(0.9, hard=True)

# #     show thirty_five_grad_after_seven_day_hes_here at thirty_five_grad_crt
