...
init -100 python in _glitch_setting:
    ...
    class _Glitch(renpy.Displayable, NoRollback):
        ...
        def __init__(self, child=None, glitch_strength=.05, _fps=5., delay=.1, **kwargs):
            ...
            if self.__delay <= .0:
                raise ValueError(__("Некорректное значение 'delay'."))
