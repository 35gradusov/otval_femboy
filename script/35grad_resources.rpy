init -1:
    python:
        ...
        thirty_five_grad_2                                                          = thirty_five_grad_sounds_directory+"ui/2.mp3"
        thirty_five_grad_3                                                          = thirty_five_grad_sounds_directory+"ui/3.mp3"
        thirty_five_grad_666                                                        = thirty_five_grad_sounds_directory+"ui/666.mp3"
...
init 1:
    ...
    # анимации
    # Пролог
    image cg video_prolog                                                           = Movie(play="video/alex_prologe.webm", loop=True, start_image='images/cg/cg_bus_station.png')

    # день 1
    image cg day1_miku_animation                                                    = Movie(play="video/cg_day1_miku_animation.webm", loop=True, start_image='images/cg/cg_day1_miku.png')
    image cg day1_slavya_animation                                                  = Movie(play="video/cg_day1_slavya_animation.webm", loop=True, start_image='images/cg/cg_day1_slavya.jpg')

    # день 2
    image cg day2_alice_animation                                                   = Movie(play="video/alice_animation.webm", loop=True, start_image='images/cg/cg_day2_alice.png')
