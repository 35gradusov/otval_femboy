init -1:
    python:
        ...
        thirty_five_grad_mi                                     = Character(u'{glitch=0.55}{color=#23e1fe}{font=SonySketch.ttf}{size=35}Мику{/size}{/color}{/font}{/glitch}', what_color="FFFFFF")
        thirty_five_grad_mi_unk                                 = Character(u'{glitch=0.55}{color=#23e1fe}{font=SonySketch.ttf}{size=35}Неизвестная{/size}{/color}{/font}{/glitch}', what_color="FFFFFF")
        thirty_five_grad_uv                                     = Character(u'{glitch=0.55}{color=#23e1fe}{font=SonySketch.ttf}{size=35}Юля{/size}{/color}{/font}{/glitch}', what_color="FFFFFF")
        thirty_five_grad_uv_unk                                 = Character(u'{glitch=0.55}{color=#23e1fe}{font=SonySketch.ttf}{size=35}Неизвестная{/size}{/color}{/font}{/glitch}', what_color="FFFFFF")
        ...
        thirty_five_grad_mi_alex                                = Character(u'{glitch=0.55}{color=#23e1fe}{font=SonySketch.ttf}{size=35}Мику/Алексей{/size}{/color}{/font}{/glitch}', what_color="FFFFFF")
        ...
        thirty_five_grad_oi1                                    = thirty_five_grad_sounds_directory+"oi1.ogg"
...
init 1:
    ...
    image thirty_five_grad_hug                                  = thirty_five_grad_cg_directory+'hug.png'
